...
def run():
    ...
    input_mrc = os.path.join(get_data_path(), "TS_030_bin2.mrc")
    ...
    tomo.download_mrcfile(binning=2, dest_path=get_data_path())
    ...
    embeddings = os.path.join(embedding_path, "TS_030_bin2_embeddings.temb")

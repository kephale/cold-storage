...
def download_and_prepare_dataset(client, crop_coords):
    ...
    demo_zarr.create_dataset('demo_image', data=cropped_img, chunks=(10, 10, 10))
...
setup(
    ...
    args=[
        {"name": "crop_z_start", "type": "integer", "required": True, "description": "Start coordinate for cropping on Z axis"},
        {"name": "crop_z_end", "type": "integer", "required": True, "description": "End coordinate for cropping on Z axis"},
        {"name": "crop_y_start", "type": "integer", "required": True, "description": "Start coordinate for cropping on Y axis"},
        {"name": "crop_y_end", "type": "integer", "required": True, "description": "End coordinate for cropping on Y axis"},
        {"name": "crop_x_start", "type": "integer", "required": True, "description": "Start coordinate for cropping on X axis"},
        {"name": "crop_x_end", "type": "integer", "required": True, "description": "End coordinate for cropping on X axis"}        
    ],
    run=run,
    dependencies={
        "parent": {
